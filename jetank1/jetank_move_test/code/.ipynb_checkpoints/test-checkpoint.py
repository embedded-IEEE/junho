...
DEFAULT_PX_POINTS_JETANK2 = "100,100;500,100;100,400;500,400"
DEFAULT_WORLD_POINTS_JETANK2 = "-50.0,100.0;50.0,100.0;-50.0,200.0;50.0,200.0"

# theta -> roll 설정(필요 시 조정)
THETA_UNIT = "rad"        # "rad" 또는 "deg"
USE_THETA_ROLL = True     # theta를 roll로 쓸지
ROLL_SCALE = 1.0
ROLL_OFFSET = 0.0
DEFAULT_ROLL = 0.0
...
def main(args=None):
    ...
    # 파라미터(mm)
    hover_z, pick_z, drop_z, phi, move_time = 50.0, -66.0, -23.0, -90.0, 5.0
